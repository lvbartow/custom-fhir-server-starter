...
public class FhirServerConfigCommon {
	...
	public FhirServerConfigCommon(AppProperties appProperties) {
		ourLog.info("Server configured to " + (appProperties.getBinary_storage_enabled() ? "allow" : "deny")
				+ " contains searches");
	...
	public JpaStorageSettings jpaStorageSettings(AppProperties appProperties) {
		...
		jpaStorageSettings.setAllowMultipleDelete(true);
		...
		jpaStorageSettings.setDeleteExpungeEnabled(true);
		jpaStorageSettings.setExpungeEnabled(true);
